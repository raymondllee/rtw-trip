        ...
        try {
            ...
            costs = costs.map((cost, index) => {
                if (!cost.id) {
                    ...
                    return Object.assign(Object.assign({}, cost), { id });
                }
                return cost;
            });
            if (needsIdFix) {
            ...
            if (saveBtn) {
                saveBtn.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        ...
                        yield bulkEditor.bulkUpdateCosts(updates);
...
function updateEditCostsStats() {
    ...
    if (totalAmountEl) {
        const totalAmount = bulkEditor.costs.reduce((sum, cost) => sum + (cost.amount_usd || cost.amount || 0), 0);
...
function initGenerateCostsTab() {
    ...
    <div style="padding: 24px; max-width: 900px; margin: 0 auto;">
      ...
      <div style="border: 1px solid #e0e0e0; border-radius: 8px; background: white; max-height: 500px; overflow-y: auto;">
        ...
        const destCosts = costs.filter(c => c.destination_id === dest.id ||
...
function initBudgetTab() {
    ...
    budgetManager = new BudgetManager(container, tripData, tripData.budget, (updatedBudget) => __awaiter(this, void 0, void 0, function* () {
...
function initialize() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            currentScenario = yield scenarioManager.getScenario(scenarioId);
            if (!currentScenario) {
            ...
            currentVersionData = yield scenarioManager.getVersion(scenarioId, currentVersion);
